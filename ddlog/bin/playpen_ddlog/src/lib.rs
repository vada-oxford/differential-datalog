...
impl Abomonation for Category{}
impl <> record::FromRecord for Category<> {
    fn from_record(val: &record::Record) -> Result<Self, String> {
        match val {
            record::Record::PosStruct(constr, _args) => {
                match constr.as_ref() {
                    "CategoryStarWars" if _args.len() == 0 => {
                        Ok(Category::CategoryStarWars{})
                    },
                    "CategoryOther" if _args.len() == 0 => {
                        Ok(Category::CategoryOther{})
                    },
                    c => Result::Err(format!("unknown constructor {} of type Category in {:?}", c, *val))
                }
            },
...
decl_enum_into_record!(Category, <>, CategoryStarWars{}, CategoryOther{});
decl_record_mutator_enum!(Category, <>, CategoryStarWars{}, CategoryOther{});
impl fmt::Display for Category {
    fn fmt(&self, __formatter: &mut fmt::Formatter) -> fmt::Result {
        match self {
            Category::CategoryStarWars{} => {
                __formatter.write_str("CategoryStarWars{")?;
                __formatter.write_str("}")
            },
            Category::CategoryOther{} => {
                __formatter.write_str("CategoryOther{")?;
                __formatter.write_str("}")
            }
        }
    }
...
impl Abomonation for Phrases{}
impl <> record::FromRecord for Phrases<> {
    fn from_record(val: &record::Record) -> Result<Self, String> {
        match val {
            record::Record::PosStruct(constr, _args) => {
                match constr.as_ref() {
                    "Phrases" if _args.len() == 1 => {
                        Ok(Phrases{phrase: <String>::from_record(&_args[0])?})
                    },
                    c => Result::Err(format!("unknown constructor {} of type Phrases in {:?}", c, *val))
                }
            },
            record::Record::NamedStruct(constr, _args) => {
                match constr.as_ref() {
                    "Phrases" => {
                        Ok(Phrases{phrase: record::arg_extract::<String>(_args, "phrase")?})
                    },
                    c => Result::Err(format!("unknown constructor {} of type Phrases in {:?}", c, *val))
                }
            },
...
decl_struct_into_record!(Phrases, <>, phrase);
decl_record_mutator_struct!(Phrases, <>, phrase: String);
impl fmt::Display for Phrases {
    fn fmt(&self, __formatter: &mut fmt::Formatter) -> fmt::Result {
        match self {
            Phrases{phrase} => {
                __formatter.write_str("Phrases{")?;
                record::format_ddlog_str(phrase, __formatter)?;
                __formatter.write_str("}")
            }
        }
    }
}
impl fmt::Debug for Phrases {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        fmt::Display::fmt(&self, f)
    }
}
...
impl Abomonation for Word1{}
impl <> record::FromRecord for Word1<> {
    fn from_record(val: &record::Record) -> Result<Self, String> {
        match val {
            record::Record::PosStruct(constr, _args) => {
                match constr.as_ref() {
                    "Word1" if _args.len() == 2 => {
                        Ok(Word1{word: <String>::from_record(&_args[0])?, cat: <Category>::from_record(&_args[1])?})
                    },
                    c => Result::Err(format!("unknown constructor {} of type Word1 in {:?}", c, *val))
                }
            },
            record::Record::NamedStruct(constr, _args) => {
                match constr.as_ref() {
                    "Word1" => {
                        Ok(Word1{word: record::arg_extract::<String>(_args, "word")?, cat: record::arg_extract::<Category>(_args, "cat")?})
                    },
                    c => Result::Err(format!("unknown constructor {} of type Word1 in {:?}", c, *val))
                }
            },
...
decl_struct_into_record!(Word1, <>, word, cat);
decl_record_mutator_struct!(Word1, <>, word: String, cat: Category);
impl fmt::Display for Word1 {
    fn fmt(&self, __formatter: &mut fmt::Formatter) -> fmt::Result {
        match self {
            Word1{word,cat} => {
                __formatter.write_str("Word1{")?;
                record::format_ddlog_str(word, __formatter)?;
                __formatter.write_str(",")?;
                fmt::Debug::fmt(cat, __formatter)?;
                __formatter.write_str("}")
            }
        }
    }
}
impl fmt::Debug for Word1 {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        fmt::Display::fmt(&self, f)
    }
}
...
impl Abomonation for Word2{}
impl <> record::FromRecord for Word2<> {
    fn from_record(val: &record::Record) -> Result<Self, String> {
        match val {
            record::Record::PosStruct(constr, _args) => {
                match constr.as_ref() {
                    "Word2" if _args.len() == 2 => {
                        Ok(Word2{word: <String>::from_record(&_args[0])?, cat: <Category>::from_record(&_args[1])?})
                    },
                    c => Result::Err(format!("unknown constructor {} of type Word2 in {:?}", c, *val))
                }
            },
            record::Record::NamedStruct(constr, _args) => {
                match constr.as_ref() {
                    "Word2" => {
                        Ok(Word2{word: record::arg_extract::<String>(_args, "word")?, cat: record::arg_extract::<Category>(_args, "cat")?})
                    },
                    c => Result::Err(format!("unknown constructor {} of type Word2 in {:?}", c, *val))
                }
            },
...
decl_struct_into_record!(Word2, <>, word, cat);
decl_record_mutator_struct!(Word2, <>, word: String, cat: Category);
impl fmt::Display for Word2 {
    fn fmt(&self, __formatter: &mut fmt::Formatter) -> fmt::Result {
        match self {
            Word2{word,cat} => {
                __formatter.write_str("Word2{")?;
                record::format_ddlog_str(word, __formatter)?;
                __formatter.write_str(",")?;
                fmt::Debug::fmt(cat, __formatter)?;
                __formatter.write_str("}")
...
impl TryFrom<&str> for Relations {
    ...
    fn try_from(rname: &str) -> Result<Self, Self::Error> {
         match rname {
        "Phrases" => Ok(Relations::Phrases),
        "Word1" => Ok(Relations::Word1),
        "Word2" => Ok(Relations::Word2),
...
impl Relations {
    pub fn is_input(&self) -> bool {
        match self {
        Relations::Word1 => true,
        Relations::Word2 => true,
            _  => false
        }
    }
}
impl TryFrom<RelId> for Relations {
    ...
    fn try_from(rid: RelId) -> Result<Self, Self::Error> {
         match rid {
        0 => Ok(Relations::Phrases),
        1 => Ok(Relations::Word1),
        2 => Ok(Relations::Word2),
...
lazy_static! {
    pub static ref RELIDMAP: FnvHashMap<Relations, &'static str> = {
        ...
        m.insert(Relations::Phrases, "Phrases");
        m.insert(Relations::Word1, "Word1");
        m.insert(Relations::Word2, "Word2");
...
lazy_static! {
    pub static ref RELIDMAPC: FnvHashMap<RelId, ffi::CString> = {
        let mut m = FnvHashMap::default();
        m.insert(0, ffi::CString::new("Phrases").unwrap_or_else(|_|ffi::CString::new(r"Cannot convert relation name to C string").unwrap()));
        m.insert(1, ffi::CString::new("Word1").unwrap_or_else(|_|ffi::CString::new(r"Cannot convert relation name to C string").unwrap()));
        m.insert(2, ffi::CString::new("Word2").unwrap_or_else(|_|ffi::CString::new(r"Cannot convert relation name to C string").unwrap()));
        m.insert(3, ffi::CString::new("__Null").unwrap_or_else(|_|ffi::CString::new(r"Cannot convert relation name to C string").unwrap()));
        m
   };
}
lazy_static! {
...
pub fn relval_from_record(rel: Relations, _rec: &record::Record) -> Result<Value, String> {
    match rel {
        Relations::Phrases => {
            Ok(Value::Phrases(boxed::Box::new(<Phrases>::from_record(_rec)?)))
        },
        Relations::Word1 => {
            Ok(Value::Word1(boxed::Box::new(<Word1>::from_record(_rec)?)))
        },
        Relations::Word2 => {
            Ok(Value::Word2(boxed::Box::new(<Word2>::from_record(_rec)?)))
        },
        Relations::__Null => {
...
pub enum Value {
    tuple0__(()),
    Category(Category),
    Phrases(boxed::Box<Phrases>),
    Word1(boxed::Box<Word1>),
    Word2(boxed::Box<Word2>)
}
...
impl fmt::Display for Value {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            ...
            Value::Category (v) => write!(f, "{:?}", *v),
            Value::Phrases (v) => write!(f, "{:?}", *v),
            Value::Word1 (v) => write!(f, "{:?}", *v),
            Value::Word2 (v) => write!(f, "{:?}", *v)
        }
    }
}
decl_val_enum_into_record!(Value, <>, tuple0__(x), Category(x), Phrases(x), Word1(x), Word2(x));
decl_record_mutator_val_enum!(Value, <>, tuple0__(()), Category(Category), Phrases(Phrases), Word1(Word1), Word2(Word2));
...
pub fn prog(__update_cb: Box<dyn CBFn<Value>>) -> Program<Value> {
    let Word1 = Relation {
                    ...
                    distinct:     false,
                    key_func:     None,
                    id:           Relations::Word1 as RelId,
                    rules:        vec![
                        ],
                    arrangements: vec![
                        Arrangement::Map{
                           name: r###"Word1{.word=_, .cat=_0}"###.to_string(),
                            afun: &{fn __f(__v: Value) -> Option<(Value,Value)>
                            {
                                let __cloned = __v.clone();
                                {
                                    if let Value::Word1(__box) = __v {
                                        match *__box {
                                        Word1{word: _, cat: ref _0} => Some(Value::Category(_0.clone())),
                                        _ => None
                                        }
                                    } else { None }
                                }.map(|x|(x,__cloned))
    ...
    let Word2 = Relation {
                    ...
                    distinct:     false,
                    key_func:     None,
                    id:           Relations::Word2 as RelId,
                    rules:        vec![
                        ],
                    arrangements: vec![
                        Arrangement::Map{
                           name: r###"Word2{.word=_, .cat=_0}"###.to_string(),
                            afun: &{fn __f(__v: Value) -> Option<(Value,Value)>
                            {
                                let __cloned = __v.clone();
                                {
                                    if let Value::Word2(__box) = __v {
                                        match *__box {
                                        Word2{word: _, cat: ref _0} => Some(Value::Category(_0.clone())),
                                        _ => None
                                        }
                                    } else { None }
                                }.map(|x|(x,__cloned))
    ...
    let Phrases = Relation {
                      name:         "Phrases".to_string(),
                      input:        false,
                      distinct:     true,
                      key_func:     None,
                      id:           Relations::Phrases as RelId,
                      rules:        vec![
                          /* Phrases(.phrase=((w1 ++ " ") ++ w2)) :- Word1(.word=w1, .cat=cat), Word2(.word=w2, .cat=cat). */
                          Rule::ArrangementRule {
                              description: "Phrases(.phrase=((w1 ++ \" \") ++ w2)) :- Word1(.word=w1, .cat=cat), Word2(.word=w2, .cat=cat).".to_string(),
                              arr: ( Relations::Word1 as RelId, 0),
                              xform: XFormArrangement::Join{
                                         description: "Word1(.word=w1, .cat=cat), Word2(.word=w2, .cat=cat)".to_string(),
                                         ffun: None,
                                         arrangement: (Relations::Word2 as RelId,0),
                                         jfun: &{fn __f(_: &Value ,__v1: &Value,__v2: &Value) -> Option<Value>
                                         {
                                             let (w1, cat) = match *__v1{
                                                 Value::Word1(ref __box) => {
                                                     match **__box {
                                                     Word1{word: ref w1, cat: ref cat} => (w1, cat),
                                                     _ => return None
                                                     }
                                                 },
                                                 _ => return None
                                             ...
                                             let w2 = match *__v2{
                                                 Value::Word2(ref __box) => {
                                                     match **__box {
                                                     Word2{word: ref w2, cat: _} => w2,
                                                     _ => return None
                                                     }
                                                 },
                                                 _ => return None
                                             };
                                             Some(Value::Phrases(boxed::Box::new(Phrases{phrase: string_append(string_append_str(w1.clone(), r###" "###), w2)})))
                                         }
                                         __f},
                                         next: Box::new(None)
                                     }
    ...
    Program {
        nodes: vec![
            ProgNode::Rel{rel: Word1},
            ProgNode::Rel{rel: Word2},
            ProgNode::Rel{rel: Phrases},
